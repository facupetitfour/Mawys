      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold mb-4 text-gray-800">Contáctanos</h2>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 pb-8 border-b border-gray-200">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-600 hover:text-[#E54B4B] transition-colors"
                  >
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-lg font-medium text-gray-800">Ubicación</h4>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-white/70 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E54B4B] text-gray-800 placeholder-gray-500"
              ...
              <div>
                <textarea
                  rows={4}
                  className="w-full px-4 py-3 bg-white/70 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E54B4B] text-gray-800 placeholder-gray-500 resize-none"
